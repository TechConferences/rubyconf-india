          ...
          {speakersData.map((speaker) => (
            <Card key={speaker.id} className="overflow-hidden border-none shadow-md hover:shadow-lg transition-shadow">
              ...
              <CardContent className="p-5">
                ...
                <div className="text-amber-600 text-sm font-medium">{speaker.role}</div>
                <div className="text-gray-500 text-sm mb-3">{speaker.company}</div>
                <div className="text-xs font-medium bg-amber-50 text-amber-700 px-3 py-1 rounded-full inline-block">
                  {speaker.topic}
                </div>
              </CardContent>
            </Card>
