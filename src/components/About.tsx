    ...
    <section id="about" className="py-20 bg-gray-50">
      <div className="container max-w-6xl">
        <div className="text-center mb-16">
          ...
          <div className="w-24 h-1 bg-ruby-600 mx-auto"></div>
        </div>

        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            <h3 className="text-2xl font-bold mb-6 text-ruby-700">The Premier Ruby Event in India</h3>
            ...
            <Button className="mt-8 bg-ruby-600 hover:bg-ruby-700">
              Learn More
            </Button>
          </div>
          ...
          <div className="order-1 md:order-2 relative">
            <div className="aspect-video rounded-2xl overflow-hidden shadow-xl">
              <div className="bg-gradient-to-br from-ruby-500 to-ruby-800 h-full w-full flex items-center justify-center p-8 text-center text-white">
                <div>
                  <div className="mb-4">
                    <svg width="80" height="64" viewBox="0 0 80 64" className="mx-auto" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path fillRule="evenodd" clipRule="evenodd" d="M40 6L72 32L40 58L8 32L40 6Z" fill="#B91C1C" />
            ...
            <div className="absolute -bottom-6 -right-6 bg-white p-5 rounded-lg shadow-lg hidden md:block">
              <div className="text-center">
                <div className="text-5xl font-bold font-display text-ruby-700">7+</div>
