          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="col-span-1">
              <div className="text-2xl font-bold mb-4">
                ...
                <span className="text-ruby-400">India</span>
              </div>
            ...
            <div>
              ...
              <form className="space-y-2">
                <input
                  ...
                  className="w-full px-4 py-2 rounded bg-white/10 border border-white/20 focus:outline-none focus:ring-1 focus:ring-ruby-400"
                />
                <Button className="w-full bg-ruby-600 hover:bg-ruby-700">
                  Subscribe
                </Button>
              </form>
            </div>
