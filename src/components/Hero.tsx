...
import RCI_hero from "@/assets/RCI_hero.jpg";
...
const Hero = () => {
  return (
    <>
        ...
        <div className="container max-w-6xl mx-auto px-4 relative z-10">
          <div className="flex flex-col items-center text-center mb-12 animate-fade-in">
            ...
            <p className="text-lg md:text-xl max-w-3xl mb-10">
              Join India's largest Ruby community for two days of inspiring
              talks, networking opportunities and{" "}
      ...
      {/* Event Details Section - Now a separate section instead of being part of Hero */}
      <section className="py-16 bg-gray-50">
        <div className="container max-w-6xl mx-auto px-4">
          <div className="bg-white/60 backdrop-blur-sm border border-gray-200 rounded-xl p-6 flex flex-col md:flex-row justify-between items-center gap-8 animate-fade-in shadow-lg">
