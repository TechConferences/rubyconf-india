      ...
      <div className="container max-w-6xl">
        <div className="text-center mb-12">
          ...
          <p className="max-w-2xl mx-auto text-gray-600">
            An entertaining session where programming languages playfully
            critique each other. Fun, educational, and guaranteed to spark
            friendly debates!
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="z-10">
              <h3 className="text-2xl font-bold mb-4">
                The Ultimate Programming Language Showdown
              </h3>
              <p className="mb-6 opacity-90">
                Join us for a spirited and entertaining session where advocates
                of Ruby, JavaScript, and Python engage in a friendly "roast" of
                each other's languages. Expect witty banter, technical
                critiques, and surprising revelations!
              </p>
              ...
              <div className="bg-white/10 backdrop-blur rounded-lg p-5 mb-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start">
                    ...
                    <div>Humorous memes and code comparisons</div>
                  </li>
                  <li className="flex items-start">
                    <div className="mr-3 mt-1 text-burgundy-300">
                      <svg
                    ...
                    <div>Audience participation and live polls</div>
                  </li>
                  <li className="flex items-start">
                    <div className="mr-3 mt-1 text-burgundy-300">
                      <svg
                    ...
                    <div>
                      Learn real-world pros and cons of popular languages
                    </div>
                  </li>
                  <li className="flex items-start">
                    <div className="mr-3 mt-1 text-burgundy-300">
                    ...
                    <div>Discover quirks, hacks, and horror stories</div>
                  </li>
                  <li className="flex items-start">
                    <div className="mr-3 mt-1 text-burgundy-300">
                      <svg
                    ...
                    <div>
                      Watch developers roast each other with code jokes and
                      brutal honesty.
                    </div>
                  </li>
                </ul>
            ...
            <div className="grid grid-cols-3 gap-4 md:gap-6">
              <div className="bg-white rounded-lg p-4 shadow-lg transform -rotate-3">
                <div className="aspect-square w-full bg-red-100 rounded flex items-center justify-center mb-3">
                  <svg
                    viewBox="0 0 32 32"
                    className="text-burgundy-700 w-12 h-12"
                    fill="currentColor"
                  >
